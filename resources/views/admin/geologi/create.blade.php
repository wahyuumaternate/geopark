                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('jenis') is-invalid @enderror" id="jenis"
                                        ...
                                        <option value="Geologi" {{ old('jenis') == 'Geologi' ? 'selected' : '' }}>
                                            Geologi
                                        </option>

                                        <option value="Biologi" {{ old('jenis') == 'Biologi' ? 'selected' : '' }}>
                                            Biologi
                                        </option>

                                        <option value="Hayati" {{ old('jenis') == 'Hayati' ? 'selected' : '' }}>
                                            Hayati
                                        </option>
