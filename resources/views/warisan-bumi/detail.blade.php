        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-9 text-center heading-section ftco-animate">
                    ...
                    <p>{{ $item['deskripsi'] ?? 'Informasi detail tentang warisan bumi di Geopark Ternate.' }}</p>
                </div>
            </div>
            ...
            <div class="row d-flex">
                <div class="col-md-6 d-flex align-items-stretch ftco-animate">
                    <div class="img d-flex w-100 align-items-center justify-content-center"
                        style="background-image:url('{{ asset('frontend/gambar/' . $item['image']) }}'); min-height: 350px; background-size: cover; background-position: center;">
                    </div>
                </div>
                ...
                <div class="col-md-6 pl-md-5 py-5 ftco-animate">
                    <div class="bg-white p-4 rounded shadow-sm">
                        ...
                        @endif
                        <p class="mb-0"><a href="{{ url('/warisan-bumi/' . $section) }}" class="btn btn-primary">Kembali ke {{ $sectionLabel }}</a></p>
                    </div>
                </div>
            </div>
        </div>
