...
@section('title', 'Peta Warisan Hayati | Geopark Ternate')
@section('meta_description', 'Peta interaktif sebaran situs warisan hayati di Geopark Ternate.')
...
@section('page_title', 'Peta Warisan Hayati')
        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-9 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">Peta Sebaran Warisan Hayati</h2>
                    <p>Jelajahi lokasi flora, fauna, dan keanekaragaman hayati Geopark Ternate melalui peta interaktif di
                        bawah ini.</p>
                </div>
            </div>
            ...
            <div class="row ftco-animate">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    <div class="peta-list" id="{{ $listId }}">
                        ...
                        @empty
                            <p class="text-muted">Belum ada data warisan hayati dengan koordinat.</p>
                        @endforelse
                    </div>
                </div>
